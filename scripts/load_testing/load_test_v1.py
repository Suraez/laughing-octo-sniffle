...
# the script sends requests to 2 benchmarks with the varying workloade being defined in ROUNDS
# and logs the activations after each round. The script can be run using

# python3 load_test_v1.py --w1 ir --w2 dh
...
parser.add_argument("--w1", default="ir", help="First workload name (e.g., ch, ir, vp). Default: ir")
parser.add_argument("--w2", default="dh", help="Second workload name (e.g., dh, vp, ir). Default: dh")
